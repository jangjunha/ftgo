...
class OrderServicePactTest {
            ...
            mapOf(
                ...
                Pair(
                    "requestMetadata", mapOf(
                        "x-ftgo-authenticated-consumer-id" to "627a9a8a-41af-4daf-a968-00ffc80b53ad"
                    )
                ),
                Pair(
                    "request", mapOf(
    ...
    fun testOrderById(mockServer: MockServer, interaction: V4Interaction.SynchronousMessages) = runBlocking {
        ...
        val order = service.findOrderById(
            UUID.fromString("6f2d06a3-5dd2-4096-8644-6084d64eae35"),
            ExplicitCallCredentials("x-ftgo-authenticated-consumer-id", "627a9a8a-41af-4daf-a968-00ffc80b53ad")
        )
